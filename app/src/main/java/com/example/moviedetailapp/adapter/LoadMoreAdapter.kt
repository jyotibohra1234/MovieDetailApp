...
import com.example.moviedetailapp.databinding.LoadMoreItemLayoutBinding

class LoadMoreAdapter(private val retry: () -> Unit) : LoadStateAdapter<LoadMoreAdapter.ViewHolder>() {

    private lateinit var binding: LoadMoreItemLayoutBinding

    override fun onCreateViewHolder(parent: ViewGroup, loadState: LoadState): ViewHolder {
        binding = LoadMoreItemLayoutBinding.inflate(LayoutInflater.from(parent.context), parent, false)
